		...
		IGuiAlarmView
		{
			...
			IGuiListCtrl
			{
				...
				IGuiListHeader
				{
					...
					qm_columnWidthList: [60, 86, 78, 545]
					color: "#ffefebef"
			...
			IGuiGraphicButton
			{
				...
				qm_BorderWidth: 1
				qm_ImageSource: "image://QSmartImageProvider/109#2#4#128#0#0"
				qm_Border.top: 15
				qm_Border.bottom: 15
				qm_Border.right: 5
				qm_Border.left: 5
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539409,486539409)
				}
			}
			IGuiGraphicButton
			{
				...
				Component.onCompleted:
				{
					proxy.initProxy(q486539410,486539410)
				}
			}
			Component.onCompleted:
			{
